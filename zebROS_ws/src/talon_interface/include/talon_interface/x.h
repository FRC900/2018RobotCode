...
class TalonHWState
{
	public:
		...
		float getMotorOutputPercent(void)    const
		{
		...
		int getClosedLoopError(void)  const
		{
			return closed_loop_error_;
		}
		float getIntegralAccumulator(void)  const
		{
			return integral_accumulator_;
		}
		float getErrorDerivative(void)      const
		{
		...
		float getVCompensationRampRate(void) const
		{
			return v_compensation_ramp_rate_;
		}
		...
		void setOutputVoltage(float output_voltage)
		{
			output_voltage_ = output_voltage;
		}
		void setOutputCurrent(float output_current)
		{
			output_current_ = output_current;
		}
		void setBusVoltage(float bus_voltage)
		{
			bus_voltage_ = bus_voltage;
		}
		void setMotorOutputPercent(float motor_output_percent)
		{
			motor_output_percent_ = motor_output_percent;
		}

		//output shaping
		void ConfigClosedloopRamp(float closedloop_secondsFromNeutralToFull)
		{
			closedloop_secondsFromNeutralToFull_ = closedloop_secondsFromNeutralToFull;
		}
		float getConfigClosedloopRamp()
		{
			return closedloop_secondsFromNeutralToFull_;
		}

		void ConfigOpenloopRamp(float openloop_secondsFromNeutralToFull)
		{
			openloop_secondsFromNeutralToFull_ = openloop_secondsFromNeutralToFull;
		}
		float getConfigOpenloopRamp()
		{
			return openloop_secondsFromNeutralToFull_;
		}
		...
		void setClosedLoopError(int closed_loop_error)
		{
			closed_loop_error_ = closed_loop_error;
		}
		void setIntegralAccumulator(float integral_accumulator)
		{
			integral_accumulator_ = integral_accumulator;
		}
		void setErrorDerivative(float error_derivative)
		{
		...
		void setVCompensationRampRate(float ramp_rate)
		{
			v_compensation_ramp_rate_ = ramp_rate;
		}

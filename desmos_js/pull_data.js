...
function loadGraph (calculator)
{
	...
	calculator.setExpression({id:'spline160', latex:'f\\left(x\\right)\\ =\\ A_xx^5+B_xx^4+C_xx^3+D_xx^2+E_xx+F_x'});
	calculator.setExpression({id:'spline161', latex:'g\\left(x\\right)\\ =\\ A_yx^5+B_yx^4+C_yx^3+D_yx^2+E_yx+F_y'});
	...
	calculator.setExpression({id:'spline174', latex:'f_1\\left(x\\right)\\ =\\ A_{x1}x^5+B_{x1}x^4+C_{x1}x^3+D_{x1}x^2+E_{x1}x+F_{x1}'});
	calculator.setExpression({id:'spline175', latex:'g_1\\left(x\\right)\\ =\\ A_{y1}x^5+B_{y1}x^4+C_{y1}x^3+D_{y1}x^2+E_{y1}x+F_{y1}'});
	...
	calculator.setExpression({id:'spline188', latex:'f_2\\left(x\\right)\\ =\\ A_{x2}x^5+B_{x2}x^4+C_{x2}x^3+D_{x2}x^2+E_{x2}x+F_{x2}'});
	calculator.setExpression({id:'spline189', latex:'g_2\\left(x\\right)\\ =\\ A_{y2}x^5+B_{y2}x^4+C_{y2}x^3+D_{y2}x^2+E_{y2}x+F_{y2}'});
	...
	calculator.setExpression({id:'spline202', latex:'f_3\\left(x\\right)\\ =\\ A_{x3}x^5+B_{x3}x^4+C_{x3}x^3+D_{x3}x^2+E_{x3}x+F_{x3}'});
	calculator.setExpression({id:'spline203', latex:'g_3\\left(x\\right)\\ =\\ A_{y3}x^5+B_{y3}x^4+C_{y3}x^3+D_{y3}x^2+E_{y3}x+F_{y3}'});
	...
	calculator.setExpression({id:'spline216', latex:'f_4\\left(x\\right)\\ =\\ A_{x4}x^5+B_{x4}x^4+C_{x4}x^3+D_{x4}x^2+E_{x4}x+F_{x4}'});
	calculator.setExpression({id:'spline217', latex:'g_4\\left(x\\right)\\ =\\ A_{y4}x^5+B_{y4}x^4+C_{y4}x^3+D_{y4}x^2+E_{y4}x+F_{y4}'});
	...
	calculator.setExpression({id:'spline230', latex:'f_5\\left(x\\right)\\ =\\ A_{x5}x^5+B_{x5}x^4+C_{x5}x^3+D_{x5}x^2+E_{x5}x+F_{x5}'});
	calculator.setExpression({id:'spline231', latex:'g_5\\left(x\\right)\\ =\\ A_{y5}x^5+B_{y5}x^4+C_{y5}x^3+D_{y5}x^2+E_{y5}x+F_{y5}'});
	...
	calculator.setExpression({id:'spline244', latex:'f_6\\left(x\\right)\\ =\\ A_{x6}x^5+B_{x6}x^4+C_{x6}x^3+D_{x6}x^2+E_{x6}x+F_{x6}'});
	calculator.setExpression({id:'spline245', latex:'g_6\\left(x\\right)\\ =\\ A_{y6}x^5+B_{y6}x^4+C_{y6}x^3+D_{y6}x^2+E_{y6}x+F_{y6}'});
	...
	calculator.setExpression({id:'spline259', latex:'f_7\\left(x\\right)\\ =\\ A_{x7}x^5+B_{x7}x^4+C_{x7}x^3+D_{x7}x^2+E_{x7}x+F_{x7}'});
	calculator.setExpression({id:'spline260', latex:'g_7\\left(x\\right)\\ =\\ A_{y7}x^5+B_{y7}x^4+C_{y7}x^3+D_{y7}x^2+E_{y7}x+F_{y7}'});
	...
	calculator.setExpression({id:'out281', latex:'\\left(a_xt^2+\\left(v_x-2\\cdot\\left(0\\right)\\cdot a_x\\right)t+\\left(p_x-\\left(0\\right)\\cdot\\left(v_x-2\\cdot\\left(0\\right)\\cdot a_x\\right)-\\left(0\\right)^2\\cdot a_x\\right),\\ a_yt^2+\\left(v_y-2\\cdot\\left(0\\right)\\cdot a_y\\right)t+\\left(p_y-\\left(0\\right)\\cdot\\left(v_y-2\\cdot\\left(0\\right)\\cdot a_y\\right)-\\left(0\\right)^2\\cdot a_y\\right)\\right)', domain:{min: -1, max: 1}});
	...
	calculator.setExpression({id:'out290', latex:'\\left(a_{x3}t^2+\\left(v_{x3}-2\\cdot\\left(3\\right)\\cdot a_{x3}\\right)t+\\left(p_{x3}-\\left(3\\right)\\cdot\\left(v_{x3}-2\\cdot\\left(3\\right)\\cdot a_{x3}\\right)-\\left(3\\right)^2\\cdot a_{x3}\\right),\\ a_{y3}t^2+\\left(v_{y3}-2\\cdot\\left(3\\right)\\cdot a_{y3}\\right)t+\\left(p_{y3}-\\left(3\\right)\\cdot\\left(v_{y3}-2\\cdot\\left(3\\right)\\cdot a_{y3}\\right)-\\left(3\\right)^2\\cdot a_{y3}\\right)\\right)', domain:{min: 2, max: 4}});
	...
	calculator.setExpression({id:'out293', latex:'\\left(a_{x4}t^2+\\left(v_{x4}-2\\cdot\\left(4\\right)\\cdot a_{x4}\\right)t+\\left(p_{x4}-\\left(4\\right)\\cdot\\left(v_{x4}-2\\cdot\\left(4\\right)\\cdot a_{x4}\\right)-\\left(4\\right)^2\\cdot a_{x4}\\right),\\ a_{y4}t^2+\\left(v_{y4}-2\\cdot\\left(4\\right)\\cdot a_{y4}\\right)t+\\left(p_{y4}-\\left(4\\right)\\cdot\\left(v_{y4}-2\\cdot\\left(4\\right)\\cdot a_{y4}\\right)-\\left(4\\right)^2\\cdot a_{y4}\\right)\\right)', domain:{min: 3, max: 5}});
	...
	calculator.setExpression({id:'out296', latex:'\\left(a_{x5}t^2+\\left(v_{x5}-2\\cdot\\left(5\\right)\\cdot a_{x5}\\right)t+\\left(p_{x5}-\\left(5\\right)\\cdot\\left(v_{x5}-2\\cdot\\left(5\\right)\\cdot a_{x5}\\right)-\\left(5\\right)^2\\cdot a_{x5}\\right),\\ a_{y5}t^2+\\left(v_{y5}-2\\cdot\\left(5\\right)\\cdot a_{y5}\\right)t+\\left(p_{y5}-\\left(5\\right)\\cdot\\left(v_{y5}-2\\cdot\\left(5\\right)\\cdot a_{y5}\\right)-\\left(5\\right)^2\\cdot a_{y5}\\right)\\right)', domain:{min: 4, max: 6}});
	...
	calculator.setExpression({id:'out299', latex:'\\left(a_{x6}t^2+\\left(v_{x6}-2\\cdot\\left(6\\right)\\cdot a_{x6}\\right)t+\\left(p_{x6}-\\left(6\\right)\\cdot\\left(v_{x6}-2\\cdot\\left(6\\right)\\cdot a_{x6}\\right)-\\left(6\\right)^2\\cdot a_{x6}\\right),\\ a_{y6}t^2+\\left(v_{y6}-2\\cdot\\left(6\\right)\\cdot a_{y6}\\right)t+\\left(p_{y6}-\\left(6\\right)\\cdot\\left(v_{y6}-2\\cdot\\left(6\\right)\\cdot a_{y6}\\right)-\\left(6\\right)^2\\cdot a_{y6}\\right)\\right)', domain:{min: 5, max: 7}});
	...
	calculator.setExpression({id:'out302', latex:'\\left(a_{x7}t^2+\\left(v_{x7}-2\\cdot\\left(7\\right)\\cdot a_{x7}\\right)t+\\left(p_{x7}-\\left(7\\right)\\cdot\\left(v_{x7}-2\\cdot\\left(7\\right)\\cdot a_{x7}\\right)-\\left(7\\right)^2\\cdot a_{x7}\\right),\\ a_{y7}t^2+\\left(v_{y7}-2\\cdot\\left(7\\right)\\cdot a_{y7}\\right)t+\\left(p_{y7}-\\left(7\\right)\\cdot\\left(v_{y7}-2\\cdot\\left(7\\right)\\cdot a_{y7}\\right)-\\left(7\\right)^2\\cdot a_{y7}\\right)\\right)', domain:{min: 6, max: 8}});
	...
	calculator.setExpression({id:'out305', latex:'\\left(a_{x8}t^2+\\left(v_{x8}-2\\cdot\\left(8\\right)\\cdot a_{x8}\\right)t+\\left(p_{x8}-\\left(8\\right)\\cdot\\left(v_{x8}-2\\cdot\\left(8\\right)\\cdot a_{x8}\\right)-\\left(8\\right)^2\\cdot a_{x8}\\right),\\ a_{y8}t^2+\\left(v_{y8}-2\\cdot\\left(8\\right)\\cdot a_{y8}\\right)t+\\left(p_{y8}-\\left(8\\right)\\cdot\\left(v_{y8}-2\\cdot\\left(8\\right)\\cdot a_{y8}\\right)-\\left(8\\right)^2\\cdot a_{y8}\\right)\\right)', domain:{min: 7, max: 9}});
	
	// FUNCTIONS
	
	calculator.setExpression({id:'func306', latex:'\\left(f\\left(t\\right),\\ g\\left(t\\right)\\right)', domain:{min: 0, max: 1}});
	...
	calculator.setExpression({id:'func312', latex:'\\left(f_6\\left(t\\right),\\ g_6\\left(t\\right)\\right)', domain:{min: 6, max: 7}});
	calculator.setExpression({id:'func315', latex:'\\left(f_7\\left(t\\right),\\ g_7\\left(t\\right)\\right)', domain:{min: 7, max: 8}});
}
